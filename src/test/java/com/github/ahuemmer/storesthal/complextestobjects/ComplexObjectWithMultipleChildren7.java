...
public class ComplexObjectWithMultipleChildren7 {
    ...
    private LinkedList<ComplexObjectWithMultipleChildren7> children;
    ...
    public LinkedList<ComplexObjectWithMultipleChildren7> getChildren() {
        return children;
    }

    @HALRelation
    public void setChildren(LinkedList<ComplexObjectWithMultipleChildren7> children) {
